...
export default function TechIcon({
  ...
  const icon = map[name];
  if (!icon) {
    const color = fallbackColors[name] ?? "#9CA3AF";
    return (
      <span
